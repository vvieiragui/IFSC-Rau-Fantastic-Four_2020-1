          ...
          <div class="row">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <div class="form-group">
                  ...
                  <input type="number" class="form-control" id="contato1" name="contato1" placeholder="(00)00000-0000">
                </div>
                <div class="form-group">  
                  <label for="contato2">Telefone</label>
                  <input type="number" class="form-control" id="contato2" name="contato2"   placeholder="(00)00000-0000">
                </div>
                <div class="form-group">  
           ...
           <!-- Inicio observações - textArea -->
            ...
            <div class="card-footer" style="margin-left: 80%;">
              <button type="submit" value="Cadastrar" class="btn btn-primary">Registrar</button>
            </div>
      </form>
      <!-- /.Fim Formulario -->
    </section>
